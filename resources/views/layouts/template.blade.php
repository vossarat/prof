...
<html lang="{{ app()->getLocale() }}">
	<head>
		...
		<meta name="google-play-app" content="app-id=com.doc.tradeunionsenim">
		...
		<link href="{{ asset('css/smart-app-banner.css') }}" rel="stylesheet">
	...
	<body>
		...
		<script src="{{ asset('js/smart-app-banner.js') }}"></script>
